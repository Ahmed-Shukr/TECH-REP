...
def ensure_fonts():
    ...
    candidates = [
        (
            ...
            "/usr/share/fonts/truetype/noto/NotoSansMono-SemiCondensed.ttf",
        ),
        (
    ...
    for regular, bold, medium, mono in candidates:
        try:
            pdfmetrics.registerFont(TTFont("NotoSC", regular))
            pdfmetrics.registerFont(TTFont("NotoSC-Bold", bold))
            pdfmetrics.registerFont(TTFont("NotoSC-Med", medium))
            pdfmetrics.registerFont(TTFont("NotoMonoSC", mono))
            pdfmetrics.registerFontFamily(
                "NotoSC",
                normal="NotoSC",
                bold="NotoSC-Bold",
                italic="NotoSC",
                boldItalic="NotoSC-Bold",
            )
...
def slide_styles():
    ...
    return {
        ...
        "h": ParagraphStyle("h", fontName=fb, fontSize=14.5, textColor=INK, leading=17, spaceAfter=1),
        "subtitle": ParagraphStyle("subtitle", fontName=f, fontSize=9.2, textColor=MUTED, leading=11.5, spaceAfter=4),
        "body": ParagraphStyle("body", fontName=f, fontSize=9.2, textColor=SLATE, leading=12, spaceAfter=2),
        ...
        "small": ParagraphStyle("small", fontName=f, fontSize=7.6, textColor=MUTED, leading=9.5),
        "code": ParagraphStyle("code", fontName=mono, fontSize=8.0, textColor=INK, leading=10.2, spaceAfter=0),
        "card_title": ParagraphStyle("card_title", fontName=fb, fontSize=7.8, textColor=BLUE, leading=9.5, spaceAfter=2),
        "card_body": ParagraphStyle("card_body", fontName=f, fontSize=8.2, textColor=SLATE, leading=10.4),
        "block_title": ParagraphStyle("block_title", fontName=fb, fontSize=8.5, textColor=INK, leading=10.5),
        "block_body": ParagraphStyle("block_body", fontName=f, fontSize=8.2, textColor=SLATE, leading=10.4),
        ...
        "table_h": ParagraphStyle("table_h", fontName=fb, fontSize=8, textColor=WHITE, leading=9.5),
        "table_c": ParagraphStyle("table_c", fontName=f, fontSize=7.6, textColor=SLATE, leading=9.5),
        "callout": ParagraphStyle("callout", fontName=f, fontSize=8.4, textColor=INK, leading=10.6),
        "example_label": ParagraphStyle("example_label", fontName=fb, fontSize=9.0, textColor=BLUE, spaceAfter=3),
