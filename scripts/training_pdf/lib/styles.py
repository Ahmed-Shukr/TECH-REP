...
def slide_styles():
    ...
    return {
        ...
        "code": ParagraphStyle("code", fontName=mono, fontSize=7.2, textColor=INK, leading=9.1, spaceAfter=0),
        ...
        "example_label": ParagraphStyle("example_label", fontName=fb, fontSize=8.5, textColor=BLUE, spaceAfter=2),
